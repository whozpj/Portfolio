  ...
  try {
    ...
    if (!GROQ_API_KEY) {
      ...
      return NextResponse.json({
        response: "Hi! I'm Prithvi's AI assistant. To enable full functionality, please set up the GROQ_API_KEY environment variable. For now, I can tell you that Prithvi is a Software Engineer at ManTech and Candlefish, studying Computer Science at UVA, and actively seeking 2026 internships.",
      });
    }

    // Extract portfolio information from the Hero component
    const portfolioContext = `
You are Prithvi Raj's AI assistant. You know everything about Prithvi based on his portfolio:
