  ...
  planets: [
    {
      ...
      bullets: [
        ...
        "Architected an automated pipeline using Google Cloud Vision and Gemini 2.5 Flash to read and extract data from 200+ vehicle label images per run, cutting manual data entry by ~90% (~2 hours to ~10 min).",
    ...
    },
    {
      ...
      status: "active",
      bullets: [
        "Eliminated 200+ hour manual labeling bottleneck by designing a scalable data synthesis engine that auto-generated 10K architectural blueprints with multi-class labels (walls, windows, doors, etc).",
